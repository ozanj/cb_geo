...
__Sorting students into colleges, perspectives from sociology:__
...
__"Geomarkets" are an input in two College Board recruiting products:__
...
1. Enrollment management: Background \& scholarship
1. Empirical case and theory
1. Methods
1. Results
1. Discussion
    - Creating a "knowledge infrastructure" [@RN5025] to study the role of private firms and private equity funding in education
...
- "Recruitment redlining": circuitous avoidance of Black and Latinx communities along visit paths [@RN4759] [INSERT CLICKABLE IMAGE OF LA MAP]

___Recruiting not a practice wholly done by colleges...___

- Data vendors and consultancies help colleges find students
...
[THIS SLIDE NEEDS LOTS OF WORK; NEED TO SHOW THE SEARCH FILTERS AS PROBLEMATIC]
Public records requests to public universities in CA, IL, MN, TX, AZ from 2016-2020

- "Order summary" specifying search filter criteria [(Sample)](https://drive.google.com/drive/u/1/folders/18CHMlUIa5OO0zRkET7eSIzYnvk4S9_U1)
- De-identified prospect-level student list [(Sample)](https://drive.google.com/drive/u/1/folders/1rDIAuHLsh3IfglSsqhNuCmYsfnbtc0tV)  
...
- Analyze descriptive relationships observed in list purchases from College Board and HSLS:09 simulated relationships
- Findings: Racial (and socioeconomic) inequity results from:
