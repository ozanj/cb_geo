...
# For RQ3, we currently have two plot types: "race" and "firstgen"
...
for (m in metros) {
  ...
  for (rq in rqs) {
    ...
    # ---------------------------------------------
      ...
      # Remove special AI/AN order from regular RQ2 display
      ...
      get_notes <- function(missing_txt = '') {
        str_replace(
          str_c(
            ...
            paste0(
              readLines(
                file.path(graphs_dir, rq, str_c('rq2_', m, '_race_row_plot_note.txt')),
                warn = FALSE
              ),
              collapse = "</br>"
            ),
    ...
    # ---------------------------------------------
    # RQ3 Logic: exclusion composition graphs
    # ---------------------------------------------
    } else if (rq == "rq3") {
      ...
      # RQ3 currently has two graph types: race and firstgen
      ...
      for (g in graph_types_rq3) {
        ...
        for (order_id in orders_for_m_rq3) {
          ...
          # First RQ3 slide gets visible heading; later ones hidden
          writeLines(str_c(
            "### Research question ",
            rq_num,
