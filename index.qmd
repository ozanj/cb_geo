...
- Enrollment Planning Service (EPS): software recommends which Geomarkets to recruit and which high schools to visit
- Student Search Service: purchase the contact information of prospects that meet "search filter" criteria
...
### Background{.hide}
#### Creating Market Segment Model and Geomarkets

Project origins

Market Segment Model

- Allocates students into four market segments based on score-sending behavior of 1980 SAT test-takers
- "local" student submits most SAT scores to institutions in their own Geomarket
- "An “in-state” student submits more SAT scores to in-state institutions than they do to local, regional, or national institutions

Geomarkets

> Zemsky & Oedel (1983) [p. 4] write that,  [Often] the market boundaries match formal political and educational divisions, reflecting natural channels of communication. Each major metropolitan area is composed of several markets, usually corresponding to the inner city, a first ring of suburbs, and an outer ring of suburbs.
