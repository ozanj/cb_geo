...
- [College Board Student Search Service, order \#448922](./assets/images/geomarket_orders_redacted.pdf){target="_blank"}

Sorting students into colleges, perspectives from sociology

- Status attainment model [e.g., @RN915]
- Cultural capital model [e.g., @RN1228]
<!-- - "Schools as sorting machines" [@RN4873] -->
- Enrollment management behavior of colleges [e.g., @RN3519]

Sociology misses an important mechanism of social reproduction:

- Third-party vendors/products sort students on behalf of colleges
- Recommendations based on historical snapshots of student demand

We investigate "Geomarkets," an input in two College Board recruiting products
...
# Scholarship on Enrollment Management


### __The U.S. Market for Higher Education__
#### _A National Voucher System_
...
- Direct providers (Title IV institutions)
...
### __Student Lists are a Match-Making Intermediary__
#### _Connecting Colleges to Prospective Students_
  
@RN2247 on emergence of a national higher education system
...
In 1972, College Board began selling lists of prospects to colleges [@belkin2019-studata]

- Student list contains contract info of prospective students who meet "search filter" criteria (e.g., test score GPA) specified by the college
  
"Lead generation" is process of connecting merchants to potential consumers

- "List-based" lead generation
  - Based on direct mail business model, but has evolved into "database arketing"
- "Behavioral-based" targeting
  - Target users of a platform while they use that platform or a partner platform
  - Contemporary lead generation in higher education moving here

### __Enrollment Management (EM)__ {.columns-2}
#### _And the Enrollment Funnel_
...
- EM office subsumes activities of recruiting, admissions, financial aid

__Interventions along the funnel__
