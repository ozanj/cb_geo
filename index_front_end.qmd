...
# Revised insert_figure() that can read either .tex or .txt title sidecars
insert_figure <- function(rq, metro, graph_type, base_path = graphs_dir) {
  ...
  # Print title/caption.
  # - New RQ3 .tex files already include heading markup like #### and subtitle italics.
  # - Older .txt files only contain the title text, so add #### here.
  ...
  # Print footnotes if the note file exists
...
# 2) Read the CSV and define metro order / RQs
...
for (m in metros) {
  ...
  for (rq in rqs) {
    ...
    # Displayed RQ number.
    # Internal file/folder names remain legacy names: rq1, rq2, rq2b, rq3.
