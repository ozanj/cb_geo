...
for (m in metros) {
  ...
  for (rq in rqs) {
    ...
    if (rq == "rq1") { 
    ...
    } else if (rq == "rq2" & (m %in% c("chicago","philadelphia","los angeles","orange county","san diego","bay area","northern new jersey"))) {
      # -------------------------------------------------
      ...
      } else if (m %in% c("philadelphia",'northern new jersey')) {
