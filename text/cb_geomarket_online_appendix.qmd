  ...
  for (rq in rqs) {
    ...
    if (rq == 'rq1') { # rq1 run for every metro area
      ...
      if (m == 'chicago') {
        ...
        figure_md <- insert_figure(metro = m, rq = rq, graph_type = 'race_row_plot')
        cat(figure_md, "\n")

        figure_md <- insert_figure(metro = m, rq = rq, graph_type = 'race_col_plot')
        cat(figure_md, "\n")
                      
        figure_md <- insert_figure(metro = m, rq = rq, graph_type = 'firstgen_row_plot')
        cat(figure_md, "\n")
        
        figure_md <- insert_figure(metro = m, rq = rq, graph_type = 'firstgen_col_plot')
        cat(figure_md, "\n")
